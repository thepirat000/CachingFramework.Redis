...
namespace CachingFramework.Redis.Contracts.Providers
{
    ...
    public interface ICacheProvider : ICacheProviderAsync
    {
        ...
        T FetchHashed<T>(string key, string field, Func<T> func, TimeSpan? expiry = null, CommandFlags flags = CommandFlags.None);
        /// <summary>
        ...
        /// <param name="expiry">The expiration timespan.</param>
        T FetchHashed<T>(string key, string field, Func<T> func, string[] tags, TimeSpan? expiry = null, CommandFlags flags = CommandFlags.None);
        /// <summary>
        ...
        /// <param name="expiry">The expiration timespan.</param>
        T FetchHashed<T>(string key, string field, Func<T> func, Func<T, string[]> tagsBuilder, TimeSpan? expiry = null, CommandFlags flags = CommandFlags.None);
        /// <summary>
        /// Fetches hashed data from the cache, using the given cache key and field, and associates the field to the tags returned by the given tag builder.
        /// If there is data in the cache with the given key, then that data is returned, and the last three parameters are ignored.
        /// If there is no such data in the cache (a cache miss occurred), then the value returned by func will be
        ...
        /// <param name="tagsBuilder">The tags builder to specify tags depending on the value.</param>
        /// <param name="expiry">The expiration timespan.</param>
        TV FetchHashed<TK, TV>(string key, TK field, Func<TV> func, Func<TV, string[]> tagsBuilder, TimeSpan? expiry = null, CommandFlags flags = CommandFlags.None);
        /// <summary>
        /// Fetches hashed data from the cache, using the given cache key and field.
        /// If there is data in the cache with the given key, then that data is returned.
        /// If there is no such data in the cache (a cache miss occurred), then the value returned by func will be
        ...
        /// <param name="func">The function that returns the cache value, only executed when there is a cache miss.</param>
        /// <param name="expiry">The expiration timespan.</param>
        TV FetchHashed<TK, TV>(string key, TK field, Func<TV> func, TimeSpan? expiry = null, CommandFlags flags = CommandFlags.None);
        /// <summary>
        /// Fetches hashed data from the cache, using the given cache key and field, and associates the field to the given tags.
        /// If there is data in the cache with the given key, then that data is returned, and the last three parameters are ignored.
        /// If there is no such data in the cache (a cache miss occurred), then the value returned by func will be
        ...
        /// <param name="tags">The tags to relate to this field.</param>
        /// <param name="expiry">The expiration timespan.</param>
        TV FetchHashed<TK, TV>(string key, TK field, Func<TV> func, string[] tags, TimeSpan? expiry = null, CommandFlags flags = CommandFlags.None);
        /// <summary>
        ...
        /// <param name="func">The function that returns the cache value, only executed when there is a cache miss.</param>
        /// <param name="expiry">The expiration timespan.</param>
        T FetchObject<T>(string key, Func<T> func, TimeSpan? expiry = null, CommandFlags flags = CommandFlags.None);
        /// <summary>
        /// Fetches data from the cache, using the given cache key.
        /// If there is data in the cache with the given key, then that data is returned.
        /// If there is no such data in the cache (a cache miss occurred), then the value returned by func will be
        ...
        /// <param name="expiry">The expiration timespan.</param>
        /// <returns>``0.</returns>
        T FetchObject<T>(string key, Func<T> func, string[] tags, TimeSpan? expiry = null, CommandFlags flags = CommandFlags.None);
        /// <summary>
        /// Fetches data from the cache, using the given cache key.
        /// If there is data in the cache with the given key, then that data is returned.
        /// If there is no such data in the cache (a cache miss occurred), then the value returned by func will be
        ...
        /// <param name="expiry">The expiration timespan.</param>
        T FetchObject<T>(string key, Func<T> func, Func<T, string[]> tagsBuilder, TimeSpan? expiry = null, CommandFlags flags = CommandFlags.None);
        /// <summary>
        ...
        void SetObject<T>(string key, T value, TimeSpan? ttl = null, When when = When.Always, CommandFlags flags = CommandFlags.None);
        /// <summary>
        ...
        /// <param name="when">Indicates when this operation should be performed.</param>
        void SetObject<T>(string key, T value, string[] tags, TimeSpan? ttl = null, When when = When.Always, CommandFlags flags = CommandFlags.None);
        /// <summary>
        ...
        T GetSetObject<T>(string key, T value, CommandFlags flags = CommandFlags.None);
        /// <summary>
        /// Relates the given tags to a key.
        /// </summary>
        /// <param name="key">The key.</param>
        /// <param name="tags">The tag(s).</param>
        void AddTagsToKey(string key, string[] tags, CommandFlags flags = CommandFlags.None);
        /// <summary>
        ...
        void RenameTagForKey(string key, string currentTag, string newTag, CommandFlags flags = CommandFlags.None);
        /// <summary>
        ...
        /// <param name="tags">The tag(s).</param>
        void AddTagsToHashField(string key, string field, string[] tags, CommandFlags flags = CommandFlags.None);
        /// <summary>
        ...
        /// <param name="tags">The tag(s).</param>
        void AddTagsToSetMember<T>(string key, T member, string[] tags, CommandFlags flags = CommandFlags.None);
        /// <summary>
        ...
        /// <param name="currentTag">The current tag.</param>
        /// <param name="newTag">The new tag.</param>
        void RenameTagForHashField(string key, string field, string currentTag, string newTag, CommandFlags flags = CommandFlags.None);
        /// <summary>
        ...
        /// <param name="currentTag">The current tag.</param>
        /// <param name="newTag">The new tag.</param>
        void RenameTagForSetMember<T>(string key, T member, string currentTag, string newTag, CommandFlags flags = CommandFlags.None);
        /// <summary>
        ...
        /// <param name="field">The field.</param>
        /// <param name="tags">The tag(s).</param>
        void RemoveTagsFromHashField(string key, string field, string[] tags, CommandFlags flags = CommandFlags.None);
        /// <summary>
        /// Removes the relation between the given tags and a key.
        /// </summary>
        /// <param name="key">The key.</param>
        /// <param name="tags">The tag(s).</param>
        void RemoveTagsFromKey(string key, string[] tags, CommandFlags flags = CommandFlags.None);
        /// <summary>
        ...
        /// <param name="tags">The tag(s).</param>
        void RemoveTagsFromSetMember<T>(string key, T member, string[] tags, CommandFlags flags = CommandFlags.None);
        /// <summary>
        ...
        /// <param name="key">The key.</param>
        /// <returns>``0.</returns>
        T GetObject<T>(string key, CommandFlags flags = CommandFlags.None);
        /// <summary>
        ...
        bool TryGetObject<T>(string key, out T value, CommandFlags flags = CommandFlags.None);
        /// <summary>
        ...
        IEnumerable<string> GetKeysByPattern(string pattern, CommandFlags flags = CommandFlags.None);
        /// <summary>
        ...
        bool KeyExpire(string key, DateTime expiration, CommandFlags flags = CommandFlags.None);
        /// <summary>
        ...
        void Remove(string[] keys, CommandFlags flags = CommandFlags.None);
        /// <summary>
        ...
        /// <param name="when">Indicates when this operation should be performed.</param>
        void SetHashed<T>(string key, string field, T value, TimeSpan? ttl = null, When when = When.Always, CommandFlags flags = CommandFlags.None);
        /// <summary>
        /// Sets the specified value to a hashset using the pair hashKey+field.
        ...
        /// <param name="ttl">Set the current expiration timespan to the whole key (not only this field). NULL to keep the current expiration.</param>
        /// <param name="when">Indicates when this operation should be performed.</param>
        void SetHashed<TK, TV>(string key, TK field, TV value, TimeSpan? ttl = null, When when = When.Always, CommandFlags flags = CommandFlags.None);
        /// <summary>
        ...
        /// <param name="ttl">Set the current expiration timespan to the whole key (not only this field). NULL to keep the current expiration.</param>
        void SetHashed<TK, TV>(string key, IEnumerable<KeyValuePair<TK, TV>> fieldValues, TimeSpan? ttl = null, CommandFlags flags = CommandFlags.None);
        /// <summary>
        /// Sets multiple values to the hashset stored on the given key related to the given tags.
        /// The field can be any serializable type
        /// </summary>
        /// <typeparam name="TK">The field type</typeparam>
        /// <typeparam name="TV">The value type</typeparam>
        /// <param name="key">The key.</param>
        /// <param name="tags">Tags to relate.</param>
        /// <param name="fieldValues">The field keys and values</param>
        /// <param name="ttl">Set the current expiration timespan to the whole key (not only this field). NULL to keep the current expiration.</param>
        void SetHashed<TK, TV>(string key, IEnumerable<KeyValuePair<TK, TV>> fieldValues, string[] tags, TimeSpan? ttl = null, CommandFlags flags = CommandFlags.None);
        /// <summary>
        /// Sets the specified value to a hashset using the pair hashKey+field.
        ...
        /// <param name="when">Indicates when this operation should be performed.</param>
        void SetHashed<T>(string key, string field, T value, string[] tags, TimeSpan? ttl = null, When when = When.Always, CommandFlags flags = CommandFlags.None);
        /// <summary>
        /// Sets the specified value to a hashset using the pair hashKey+field.
        /// The field can be any serializable type
        /// (The latest expiration applies to the whole key)
        ...
        /// <param name="ttl">Set the current expiration timespan to the whole key (not only this hash). NULL to keep the current expiration.</param>
        /// <param name="when">Indicates when this operation should be performed.</param>
        void SetHashed<TK, TV>(string key, TK field, TV value, string[] tags, TimeSpan? ttl = null, Contracts.When when = Contracts.When.Always, CommandFlags flags = CommandFlags.None);
        /// <summary>
        ...
        void AddToSet<T>(string key, T value, string[] tags = null, TimeSpan? ttl = null, CommandFlags flags = CommandFlags.None);
        /// <summary>
        ...
        bool RemoveFromSet<T>(string key, T value, CommandFlags flags = CommandFlags.None);
        /// <summary>
        ...
        /// <param name="tags">The tags to relate to this member.</param>
        /// <param name="ttl">Set the current expiration timespan to the whole key (not only this set). NULL to keep the current expiration.</param>
        void AddToSortedSet<T>(string key, double score, T value, string[] tags = null, TimeSpan? ttl = null, CommandFlags flags = CommandFlags.None);
        /// <summary>
        ...
        /// <param name="key">The redis set key.</param>
        /// <param name="value">The member value to remove</param>
        bool RemoveFromSortedSet<T>(string key, T value, CommandFlags flags = CommandFlags.None);
        /// <summary>
        ...
        /// <param name="field">The field.</param>
        /// <returns>``0.</returns>
        T GetHashed<T>(string key, string field, CommandFlags flags = CommandFlags.None);
        /// <summary>
        /// Gets a specified hased value from a key
        /// </summary>
        ...
        /// <param name="key">The key.</param>
        /// <param name="field">The field.</param>
        TV GetHashed<TK, TV>(string key, TK field, CommandFlags flags = CommandFlags.None);
        /// <summary>
        ...
        bool TryGetHashed<T>(string key, string field, out T value, CommandFlags flags = CommandFlags.None);
        /// <summary>
        ...
        /// otherwise, the default value for the type of the value parameter.</param>
        /// <returns>True if the cache contains a hashed element with the specified key and field; otherwise, false.</returns>
        bool TryGetHashed<TK, TV>(string key, TK field, out TV value, CommandFlags flags = CommandFlags.None);
        /// <summary>
        /// Removes a specified hased value from cache assuming the field as a string
        /// </summary>
        /// <param name="key">The key.</param>
        /// <param name="field">The field.</param>
        bool RemoveHashed(string key, string field, CommandFlags flags = CommandFlags.None);
        /// <summary>
        ...
        /// <param name="key">The key.</param>
        /// <param name="field">The field.</param>
        bool RemoveHashed<TK>(string key, TK field, CommandFlags flags = CommandFlags.None);
        /// <summary>
        ...
        IDictionary<string, T> GetHashedAll<T>(string key, CommandFlags flags = CommandFlags.None);
        /// <summary>
        ...
        /// <typeparam name="TV">The value type</typeparam>
        /// <param name="key">The redis key.</param>
        IDictionary<TK, TV> GetHashedAll<TK, TV>(string key, CommandFlags flags = CommandFlags.None);
        /// <summary>
        ...
        IEnumerable<KeyValuePair<string, T>> ScanHashed<T>(string key, string pattern, int pageSize = 10, CommandFlags flags = CommandFlags.None);
        /// <summary>
        /// Flushes all the databases on every master node.
        /// </summary>
        void FlushAll(CommandFlags flags = CommandFlags.None);
        /// <summary>
        ...
        bool HyperLogLogAdd<T>(string key, T[] items, CommandFlags flags = CommandFlags.None);
        /// <summary>
        ...
        /// <returns><c>true</c> if at least 1 HyperLogLog internal register was altered, <c>false</c> otherwise.</returns>
        bool HyperLogLogAdd<T>(string key, T item, CommandFlags flags = CommandFlags.None);
        /// <summary>
        ...
        /// </summary>
        /// <param name="key">The redis key.</param>
        long HyperLogLogCount(string key, CommandFlags flags = CommandFlags.None);
        /// <summary>
