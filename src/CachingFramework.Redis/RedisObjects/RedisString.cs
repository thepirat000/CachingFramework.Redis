...
namespace CachingFramework.Redis.RedisObjects
{
    ...
    internal class RedisString : RedisBaseObject, IRedisString, IRedisStringAsync, IEnumerable<byte>
    {
        ...
        {
            return await GetRedisDb().StringAppendAsync(RedisKey, value).ForAwait();
        }
        /// <inheritdoc />
        ...
        {
            await GetRedisDb().StringSetAsync(RedisKey, value).ForAwait();
        }
        /// <inheritdoc />
        ...
        {
            return await GetRedisDb().StringGetSetAsync(RedisKey, value).ForAwait();
        }
        /// <inheritdoc />
        ...
        {
            return (long) await GetRedisDb().StringGetSetAsync(RedisKey, value).ForAwait();
        }
        /// <inheritdoc />
        ...
        {
            return (double) await GetRedisDb().StringGetSetAsync(RedisKey, value).ForAwait();
        }
        /// <inheritdoc />
        ...
        {
            return await GetRedisDb().StringGetAsync(RedisKey).ForAwait();
        }
        /// <inheritdoc />
        ...
        {
            return (long)await GetRedisDb().StringSetRangeAsync(RedisKey, offset, value).ForAwait();
        }
        /// <inheritdoc />
        ...
        {
            return await GetRedisDb().StringGetRangeAsync(RedisKey, start, stop).ForAwait();
        }
        /// <inheritdoc />
        ...
        {
            return await GetRedisDb().StringIncrementAsync(RedisKey, increment).ForAwait();
        }
        /// <inheritdoc />
        ...
        {
            var value = await GetRedisDb().StringGetAsync(RedisKey).ForAwait();
            return value.IsNull ? @default : (long)value;
        }
        /// <inheritdoc />
