...
* Note: The *Serializable* attribute is only needed when using the default [binary serializer](https://github.com/thepirat000/CachingFramework.Redis#serialization). If you use the, for example, a [JSon Serializer](https://www.nuget.org/packages/CachingFramework.Redis.Json/), the Serializable attribute becomes unnecessary.
