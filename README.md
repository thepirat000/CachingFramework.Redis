...
| ----------- | ----------------------- | -------------------------- | ------------------ |
|**BinarySerializer** | Full inheritance support | Data is compressed and not human readable | Serialization cannot be configured (apart from NonSerialized attribute)| 
